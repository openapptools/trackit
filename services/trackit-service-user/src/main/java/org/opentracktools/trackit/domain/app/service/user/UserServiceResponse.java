...
public class UserServiceResponse extends ServiceResponse {
	 ...
	 * @param success
	 */
	private UserServiceResponse(int code, boolean success) {
		super(code, success);
	}
	 ...
	 * @return
	 */
	public static UserServiceResponse success(Object result) {
		UserServiceResponse successResponse = new UserServiceResponse(200, true);
	 ...
	 * @return
	 */
	public static UserServiceResponse created(Object result) {
		UserServiceResponse createdResponse = new UserServiceResponse(302, true);
	 ...
	 * @return
	 */
	public static UserServiceResponse error(Object result) {
		UserServiceResponse errorResponse = new UserServiceResponse(500, false);
