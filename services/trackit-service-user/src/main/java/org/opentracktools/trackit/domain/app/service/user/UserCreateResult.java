...
import org.opentracktools.trackit.web.payload.response.Result;

/**
 * @author Arpan Mukhopadhyay
 *
 */
public class UserCreateResult extends UserResult implements Result {

	public static UserCreateResult success(UserEntity userEntity) {
